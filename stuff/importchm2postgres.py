...
def load(mpath, cpath, nullvalue):
    columnCHM = "chm"
    coordMetric, fields = metric(mpath, nullvalue)
    coordCHM = chm(cpath, nullvalue)
    fields.append(columnCHM)
    return fields, merge(coordMetric, coordCHM, nullvalue)
